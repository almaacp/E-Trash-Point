...
<div class="container animated-content">
    <div class="row">
        <div class="col">
            <h1 class="text-center" style="font-weight:bold; color: green">NEW KONTER</h1>
            <p class="mb-5 text-center" style="font-size: 15pt">Masukkan lokasi cabang konter terbaru</p>
        </div>
    </div>
    <div class="row">
